                  ...
                  transition">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <label class="flex items-center gap-2 text-gray-500">
                            ...
                            <input type="checkbox" name="remember" class="rounded border-gray-300 text-indigo-500">

                            Ingat Saya

                        </label>

                        <a href="{{ route('password.request') }}" class="text-indigo-500 hover:text-indigo-600 transition">
                            Lupa Password?
                        </a>
